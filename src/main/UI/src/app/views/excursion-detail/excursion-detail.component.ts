...
export class ExcursionDetailComponent implements OnInit {
  ...
  vacationUrl: string = environment.API_URL + '/api/vacations';
  excursionsUrl = environment.API_URL + "/api/excursions/";
  cartItemsUrl: string = environment.API_URL + '/api/cartItems';
  cartsUrl = environment.API_URL + "/api/carts";
  cartUrl: string = '';
  cartId: number = 0;
